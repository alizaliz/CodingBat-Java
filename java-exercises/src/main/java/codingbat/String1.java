...
/**
 * Basic string problems -- no loops. Use + to combine Strings, str.length() is
 * the number of chars in a String, str.substring(i, j) extracts the substring
