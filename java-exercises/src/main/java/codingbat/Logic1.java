...
public final class Logic1 {
    ...
    public boolean lastDigit(int a, int b, int c) {
        return equalRight(a, b) || equalRight(a, c) || equalRight(b, c);
    }

    public boolean equalRight(int a, int b) {
        return a % 10 == b % 10;
    }
    ...
    public boolean lessBy10(int a, int b, int c) {
        return isTenLess(a, b) || isTenLess(b, c) || isTenLess(a, c);
    }

    public boolean isTenLess(int a, int b) {
        return java.lang.Math.abs(a - b) >= 10;
    }
    ...
    public boolean shareDigit(int a, int b) {
        ...
        return aSplit[0] == bSplit[0] || aSplit[0] == bSplit[1] || aSplit[1] == bSplit[0] || aSplit[1] == bSplit[1];
    }
