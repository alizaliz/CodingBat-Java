...
public class Map1Test {
        ...
        public void mapShareTest() {
                ...
                assertEquals(Map.of("a", "xyz", "b", "xyz", "d", "ddd", "e", "everything"), map1TestObject
                                .mapShare(Map.of("a", "xyz", "b", "1234", "c", "yo", "d", "ddd", "e", "everything")));
        }
        ...
        public void mapABTest() {
                ...
                assertEquals(Map.of("a", "aaa", "ab", "aaabbb", "b", "bbb", "c", "ccc"),
        ...
        public void topping1Test() {
                ...
                assertEquals(Map.of("bread", "butter", "ice cream", "cherry", "salad", "oil"), map1TestObject
                                .topping1(Map.of("bread", "jam", "ice cream", "strawberries", "salad", "oil")));
        }
        ...
        public void topping3Test() {
                assertEquals(Map.of("fries", "ketchup", "potato", "ketchup"),
                ...
                assertEquals(Map.of("toast", "butter", "spinach", "oil", "salad", "oil", "potato", "ketchup", "fries",
                                "ketchup"),
                                map1TestObject.topping3(
        ...
        public void mapAB4Test() {
                ...
                assertEquals(Map.of("a", "aa", "b", "bbb", "c", "bbb"),
                                map1TestObject.mapAB4(Map.of("a", "aa", "b", "bbb")));
