...
public final class Arrays1Test {
    ...
    public void make2Test() {
        assertArrayEquals(new int[] { 4, 5 }, arrays1testObject.make2(new int[] { 4, 5 }, new int[] { 1, 2, 3 }));
        assertArrayEquals(new int[] { 4, 1 }, arrays1testObject.make2(new int[] { 4 }, new int[] { 1, 2, 3 }));
        assertArrayEquals(new int[] { 1, 2 }, arrays1testObject.make2(new int[] {}, new int[] { 1, 2 }));
        assertArrayEquals(new int[] { 1, 2 }, arrays1testObject.make2(new int[] { 1, 2 }, new int[] {}));
        assertArrayEquals(new int[] { 3, 1 }, arrays1testObject.make2(new int[] { 3 }, new int[] { 1, 2, 3 }));
        assertArrayEquals(new int[] { 3, 1 }, arrays1testObject.make2(new int[] { 3 }, new int[] { 1 }));
        assertArrayEquals(new int[] { 3, 1 }, arrays1testObject.make2(new int[] { 3, 1, 4 }, new int[] {}));
        assertArrayEquals(new int[] { 1, 1 }, arrays1testObject.make2(new int[] { 1 }, new int[] { 1 }));
        assertArrayEquals(new int[] { 1, 2 }, arrays1testObject.make2(new int[] { 1, 2, 3 }, new int[] { 7, 8 }));
        assertArrayEquals(new int[] { 7, 8 }, arrays1testObject.make2(new int[] { 7, 8 }, new int[] { 1, 2, 3 }));
